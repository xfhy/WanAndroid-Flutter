...
import 'package:wanandroidflutter/generated/json/login_data_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case LoginDataEntity:
			return loginDataEntityFromJson(data as LoginDataEntity, json) as T;			case ArticleDataEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case LoginDataEntity:
			return loginDataEntityToJson(data as LoginDataEntity);			case ArticleDataEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'LoginDataEntity':
			return LoginDataEntity().fromJson(json);			case 'ArticleDataEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'LoginDataEntity':
			return List<LoginDataEntity>();			case 'ArticleDataEntity':
